  ...
  data() {
    return {
      ...
      items: [
        ...
        { title: 'Emsile (Fiil Eşleştirme)', link: '/eslestirme', description: 'Arapça alıştırma', icon: 'mdi-abjad-arabic', iconColor: 'blue'},
        ...
        { title: 'Kelimeler', link: '/kelimeler', description: 'Alıştırmada çıkan kelimeler...', icon:'mdi-volume-high', iconColor:'blue' },
      ],
    }
  },
})
